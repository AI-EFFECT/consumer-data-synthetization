...
# Same .env the platform services read (services/.env), so SENTINEL_V08_TOKEN
...
VCPES_HOST = os.getenv("VCPES_HOST") or "vcpes08.inesctec.pt"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--device-ids",
        default=None,
        help="Comma-separated subset. Defaults to every id in Smart_Meters_IDs.",
    )
    parser.add_argument(
        "--parameters",
        default=None,
